...
const ForgetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const errMsg =
        catchErr instanceof Error ? catchErr.message : "An error occurred";
      setError(errMsg);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <>
      <div
        ...
        // ✅ Use imported module in the CSS background
      ...
      >
        <div className="w-full max-w-md bg-white border border-gray-300 rounded-xl p-8 shadow-2xl">
          ...
          <p className="text-center text-sm text-gray-700 mb-4">
            Enter the email address you used to register your account in the{" "}
            <strong>SWUMED Repository System</strong>. We’ll send you an email
