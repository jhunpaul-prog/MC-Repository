    ...
    try {
      ...
      navigate("/upload-research/conference-paper/details", {
        state: {
          ...
          fileBlob: selectedFile, // ✅ include original file for PDF preview
          uploadType,
            ...
            {!selectedFile ? (
              ...
              <div className="flex items-center justify-between border rounded-lg p-4 text-gray-600 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm cursor-pointer hover:underline" onClick={() => window.open(URL.createObjectURL(selectedFile), '_blank')}>{selectedFile.name}</span>
                </div>
                <button
