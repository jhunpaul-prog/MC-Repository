...
const FormatManagement: React.FC = () => {
  ...
  // --- Sidebar responsiveness like AdminDashboard ---
  const initialOpen =
        ...
        <main className="pt-16 sm:pt-20 p-4 md:p-6 max-w-[1400px] mx-auto w-full">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-gray-700 text-white hover:bg-gray-800"
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between px-4 py-4">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Create and manage metadata formats for your academic
                  resources.
                </div>
              </div>
            ...
            <div className="flex flex-wrap gap-2 px-4 pb-4">
              <input
                ...
                className="border border-gray-300 rounded px-3 py-2 text-sm flex-1 min-w-[220px] text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400"
              />
              <select
                value={statusFilter}
            ...
            <div className="md:hidden divide-y">
              ...
              {filtered.map((f) => {
                const key = slugify(f.formatName);
                const usage =
                  usageByCategory[key] ?? usageByCategory[f.formatName] ?? 0;
                return (
                  <div key={f.id} className="p-4">
                    ...
                    <div className="flex flex-col gap-1 text-sm mt-3">
                      <div>
                        <span className="text-gray-500">Usage:</span> {usage}
                      </div>
                      <div>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-lg p-6 shadow">
            ...
            <p className="text-gray-700">
              “<span className="font-semibold">{archiveTarget.formatName}</span>
              ” will be moved to Archives. You can restore it later from Manage
              Archives.
            </p>
